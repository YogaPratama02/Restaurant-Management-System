        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3 col-sm-4 col-lg-3 col-5 form-group input-daterange">
                    <input type="text" name="date_start" id="date_start" class="form-control text-center"
                        placeholder="from date.." readonly />
                </div>
                <div class="col-md-3 col-sm-4 col-lg-3 col-5 form-group">
                    <input type="text" name="date_end" id="date_end" class="form-control text-center"
                        placeholder="end date.." readonly />
                </div>
                <div class="col-md-3 col-sm-4 col-lg-3 col-5">
                    <button type="button" name="filter" id="filter" class="btn text-black"
                        style="background-color: #97cf6e">Filter</button>
                    <button type="button" name="refresh" id="refresh" class="btn text-black"
                        style="background-color: #97cf6e">Refresh</button>
                </div>
                <div class="col-md-3 col-sm-4 col-lg-3 col-5">
                    <button type="button" class="btn text-black excel" style="background-color: #97cf6e">Export To
                        Excel</button>
                </div>
            </div>
            <div class="row">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#date_end").datepicker({
                ...
                $("#date_end").datepicker('update', new Date(e.date.getFullYear(), e.date.getMonth() + 1,
                    0));
            });
        ...
        $('.excel').click(function() {
            ...
            var date_end = $('#date_end').val();
            if (date_start != '' && date_end != '') {
                window.location.href = "/report/purchase/export?date_start=" + date_start + "&date_end=" + date_end;
            } else {
                alert('Both date is required');
            }
        });
