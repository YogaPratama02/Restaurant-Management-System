<div class="container">
    ...
    @endphp
        <div class="card ml-3 amazing" style="width: 18rem; background-color: #ff7b54">
                    ...
                    <div class="card ml-3 mr-3">
                        <ul class="list-group list-group-flush">
                            ...
                            @if ($saleDetail->status == 'confirm')
                                <div class="btn" style="background-color: #ffd56b" id="ayo" data-id='{!! $saleDetail->id !!}'>Confirm</div>
                            @endif
