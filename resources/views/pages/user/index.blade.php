            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    <div class="card-header" style="background-color:#295192">
                        ...
                        <a href="{{route('user.create')}}" class="btn btn-success btn-sm float-right modal-show text-white" title="Create User"><i class="fas fa-plus text-white"></i> Create User</a>
                    </div>
                    <div class="card-body">
