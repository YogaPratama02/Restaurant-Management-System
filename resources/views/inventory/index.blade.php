            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    <div class="card-header" style="background-color:#295192">
                        ...
                        <a href="{{ route('inventory.create') }}" class="btn btn-success btn-sm float-right modal-show text-white" title="Create Menu"><i class="fas fa-plus"></i> Create Inventory</a>
                    </div>
                    <div class="card-body">
