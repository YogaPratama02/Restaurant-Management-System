            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    <div class="card-header" style="background-color:#97cf6e">
                        ...
                        <a href="{{ route('inventory.create') }}" class="btn btn-sm float-right modal-show text-white" style="background-color:#F3B949" title="Create Inventory"><i class="fas fa-plus"></i> Create Inventory</a>
                    </div>
                    <div class="card-body">
